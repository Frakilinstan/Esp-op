...
local tL=Instance.new("TextLabel",TopBar) tL.Size=UDim2.new(0,220,1,0) tL.Position=UDim2.new(0,14,0,0) tL.BackgroundTransparency=1 tL.Text="frklinstan_SCRIPTS" tL.TextColor3=WHITE tL.TextSize=15 tL.Font=FONT tL.TextXAlignment=Enum.TextXAlignment.Left
...
ml.Text=" frakilnstan_SCRIPTS V1.0" ml.TextColor3=GREY ml.TextSize=11 ml.Font=FONT
